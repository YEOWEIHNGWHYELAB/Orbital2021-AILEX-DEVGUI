...
def main(arg):
    ...
    try:
        ...
        vehicle.add_impulse(carla.Vector3D(0, 5 * impulse, 0))
        vehicle1.add_impulse(carla.Vector3D(0, 5 * impulse, 0))
        vehicle2.add_impulse(carla.Vector3D(0, 5 * impulse, 0))
        vehicle3.add_impulse(carla.Vector3D(0, 5 * impulse, 0))
        wait(world)
